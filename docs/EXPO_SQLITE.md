...
Available on platforms android, ios, macos, tvos, web, expo-go
...
- `getEachAsync(source: string, params: SQLiteBindParams): AsyncIterableIterator<T, any, any>`
...
- `getEachSync(source: string, params: SQLiteBindParams): IterableIterator<T, any, any>`
